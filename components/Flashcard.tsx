...
const Flashcard: React.FC<FlashcardProps> = ({ wordData }) => {
  return (
    <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-slate-700 shadow-lg w-full transform transition-all duration-300 hover:scale-[1.03] hover:shadow-purple-500/20 hover:border-purple-500/80 min-h-[250px] flex flex-col justify-between relative overflow-hidden group">
